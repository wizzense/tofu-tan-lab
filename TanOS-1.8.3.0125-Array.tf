...
resource "hyperv_machine_instance" "tanos_vm" {
  ...
  memory_maximum_bytes                    = 8589934592 # 4 GB
  ...
  hard_disk_drives {
    ...
    path                            = hyperv_vhd.tanos_vhd[count.index].path
