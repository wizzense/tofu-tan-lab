...
resource "hyperv_machine_instance" "server_core_2025_vm" {
  ...
  hard_disk_drives {
    ...
    path                            = hyperv_vhd.server2025_vhd[count.index].path
